...
class SewerCode(NonConsumable):
    def __init__(self):
        self.name = "Sewer Code"
        self.description = """A code of numbers that seems to have another assigned number to it, 
        such as the number 1 actually means 3, it seems like each number should add 2 to reveal the real number."""
        self.value = 0

class SewerCode2(NonConsumable):
    def __init__(self):
        self.name = "Sewer Code 2"
        self.description = """Similar to the first code, these numbers require the user to subtract 2 from
        the number to reveal the real number."""
        self.value = 0